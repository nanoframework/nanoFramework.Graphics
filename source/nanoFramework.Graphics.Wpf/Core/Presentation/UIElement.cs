...
namespace nanoFramework.Presentation
{
    ...
    public abstract class UIElement : DispatcherObject
    {
        ...
        protected virtual void OnGenericEvent(GenericEventArgs e)
        {
            ...
            switch ((EventCategory)genericEvent.Category)
            {
                case (EventCategory)EventCategoryEx.Gesture:
                    {
                        TouchGestureEventArgs ge = new TouchGestureEventArgs();

                        ge.Gesture = (TouchGesture)genericEvent.Message;
                        ge.X = genericEvent.X;
                        ge.Y = genericEvent.Y;
                        ge.Arguments = (ushort)genericEvent.Data;
...
#if TNANOCLR_TRACE_DEBUG_LAYOUT
            if (true)
            {
