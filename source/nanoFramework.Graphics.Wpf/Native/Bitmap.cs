...
namespace nanoFramework.UI
{
    ...
    public sealed class Bitmap : MarshalByRefObject, IDisposable
    {
        ...
        {
//            int bpp, orientation;
// Netmf      Microsoft.SPOT.Hardware.HardwareProvider hwProvider1 = Microsoft.SPOT.Hardware.HardwareProvider.HwProvider;
//            hwProvider1.GetLCDMetrics(out MaxWidth, out MaxHeight, out bpp, out orientation);

// New
            MaxWidth = SystemMetrics.ScreenWidth;
            MaxHeight = SystemMetrics.ScreenHeight;
...
#pragma warning disable 169
        private object m_bitmap;    // Do not delete m_bitmap, this is linked to the underlying C/C++ code via magic
