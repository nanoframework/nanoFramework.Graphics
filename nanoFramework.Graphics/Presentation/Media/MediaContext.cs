...
namespace nanoFramework.Presentation.Media
{
    ...
    internal class MediaContext : DispatcherObject , IDisposable
    {
        ...
        internal MediaContext()
        {
            ...
            _screen = new Bitmap(DisplayControl.ScreenWidth, DisplayControl.ScreenHeight);
        }
        ...
        private int _screenW = DisplayControl.ScreenWidth, _screenH = DisplayControl.ScreenHeight;
        private int _dirtyX0 = DisplayControl.ScreenWidth, _dirtyY0 = DisplayControl.ScreenHeight, _dirtyX1 = 0, _dirtyY1 = 0;
