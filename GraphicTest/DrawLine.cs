...
namespace Primitives.SimplePrimitives
{
    ...
    class PagedText
    {
        ...
        public PagedText(Bitmap fullScreenBitmap, Font fntSegoeUIRegular12)

        {
            ...
            do
            {
                ...
                fullScreenBitmap.DrawRectangle(Color.White, 1, 5, 5, 100, 100, 0, 0, Color.Black, 0, 0, Color.Black, 0, 0, Bitmap.OpacityOpaque);
